<div class="fixed-plugin d-lg-none">
    <a class="fixed-plugin-button text-dark position-fixed px-3 py-2" role="button" href="#offcanvasWithBothOptions" data-bs-toggle="offcanvas" aria-controls="offcanvasWithBothOptions">
      <i class="fa fa-bell cursor-pointer" style="color: #285430;"></i>
    </a>
