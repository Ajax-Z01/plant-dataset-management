...
@section('content')
  ...
  <section>
    <div class="page-header align-items-start min-vh-100 pt-5" style="background-image: url('{{asset('assets/img/curved-images/green-2.jpg')}}');">
      <span class="mask bg-gradient-dark opacity-3"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-3 mt-5 font-weight-light" style="font-size: 40px">Create your account.</h1>
          </div>
        </div>
        <div class="row mt-lg-n10 mt-md-n11 mt-n10 pt-10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card mb-5">
              <div class="card-header text-center pt-4 pb-1 text-success">
                <h5>Register with</h5>
              </div>
              <div class="row px-xl-5 px-sm-4 px-3">
                <div class="text-center me-auto px-1">
                  <a class="btn btn-outline-light w-24" href="{{ route('google.redirect') }}">
