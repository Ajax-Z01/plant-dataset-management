                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{asset('assets/img/team-1.jpg')}}" class="avatar avatar-sm me-3">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{asset('assets/img/team-4.jpg')}}" class="avatar avatar-sm me-3">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{asset('assets/img/marie.jpg')}}" class="avatar avatar-sm me-3">
                                        </div>
                                    </td>
                                    <td class="text-center">
